...
/* Private defines -----------------------------------------------------------*/
#define ENC_MENU_B_Pin GPIO_PIN_11
#define ENC_MENU_B_GPIO_Port GPIOC
#define MENU_BUTTON_Pin GPIO_PIN_12
...
#define jack_open_2_Pin GPIO_PIN_0
#define jack_open_2_GPIO_Port GPIOD
#define jack_close_2_Pin GPIO_PIN_1
#define jack_close_2_GPIO_Port GPIOD
#define jack_open_1_Pin GPIO_PIN_4
#define jack_open_1_GPIO_Port GPIOD
#define jack_close_1_Pin GPIO_PIN_5
#define jack_close_1_GPIO_Port GPIOD
#define CLOSE_RECEIVER_INPUT_3_Pin GPIO_PIN_6
#define CLOSE_RECEIVER_INPUT_3_GPIO_Port GPIOD
#define OPEN_RECEIVER_INPUT_3_Pin GPIO_PIN_3
#define OPEN_RECEIVER_INPUT_3_GPIO_Port GPIOB
#define CLOSE_RECEIVER_INPUT_4_Pin GPIO_PIN_4
#define CLOSE_RECEIVER_INPUT_4_GPIO_Port GPIOB
#define OPEN_RECEIVER_INPUT_4_Pin GPIO_PIN_5
#define OPEN_RECEIVER_INPUT_4_GPIO_Port GPIOB
#define OPEN_RECEIVER_INPUT_2_Pin GPIO_PIN_6
#define OPEN_RECEIVER_INPUT_2_GPIO_Port GPIOB
#define CLOSE_RECEIVER_INPUT_1_Pin GPIO_PIN_7
#define CLOSE_RECEIVER_INPUT_1_GPIO_Port GPIOB
#define OPEN_RECEIVER_INPUT_1_Pin GPIO_PIN_8
#define OPEN_RECEIVER_INPUT_1_GPIO_Port GPIOB
#define CLOSE_RECEIVER_INPUT_2_Pin GPIO_PIN_9
#define CLOSE_RECEIVER_INPUT_2_GPIO_Port GPIOB
#define ENC_MENU_A_Pin GPIO_PIN_10
