...
typedef struct {
		...
		uint8_t encoder_btn_clicked;
		uint8_t encoder_btn_current;
		uint8_t encoder_btn_previous;
	
		int16_t encoder_position;
		uint32_t encoder_position_timer;
		uint32_t encoder_btn_clicked_timer;
		uint32_t show_menu_timer;
		uint8_t state[2];
		uint8_t menu_number;
...
extern uint8_t setting_state[2];
extern const int8_t trans_table[16];
...
extern uint32_t receiver_read_timer;
extern uint32_t millis;
extern uint8_t  receiver_curr_order[8];
extern uint8_t  receiver_prev_order[8];
...
typedef struct {
    volatile uint16_t vars[12];   // 24 bytes
		...
		volatile uint8_t setting_prev_state[2];
...
extern uint8_t tx_buf_2[8];
extern uint8_t rx_buf[EEPROM_SIZE];

extern volatile uint8_t AT24_page_write_counter;
extern volatile uint32_t AT24_page_write_timer;
extern uint32_t AT24_write_timer;
extern volatile uint8_t AT24_write_flag;
extern uint8_t supply_feedback;

extern volatile uint8_t AT24_State;
extern volatile uint8_t AT24_first_read_flag;

extern void AT24Init(I2C_HandleTypeDef *hi2c);


extern HAL_StatusTypeDef AT24_WriteAll_IT(void);
extern HAL_StatusTypeDef AT24_ReadAll_IT(void);

extern void turnOffDevice(void);
extern void AT24Run(void);


extern void AT24_TxComplete(void);
extern void AT24_RxComplete(void);
...
/* Private defines -----------------------------------------------------------*/
#define interface_encoder_B_Pin GPIO_PIN_11
#define interface_encoder_B_GPIO_Port GPIOC
#define interface_button_Pin GPIO_PIN_12
#define interface_button_GPIO_Port GPIOC
#define motor_1_green_led_Pin GPIO_PIN_13
...
#define motor_2_move_up_Pin GPIO_PIN_5
#define motor_2_move_up_GPIO_Port GPIOA
#define motor_2_move_down_Pin GPIO_PIN_6
#define motor_2_move_down_GPIO_Port GPIOA
#define motor_1_move_up_Pin GPIO_PIN_7
#define motor_1_move_up_GPIO_Port GPIOA
#define motor_1_move_down_Pin GPIO_PIN_0
#define motor_1_move_down_GPIO_Port GPIOB
#define motor_2_position_B_Pin GPIO_PIN_1
#define motor_2_position_B_GPIO_Port GPIOB
#define motor_2_position_A_Pin GPIO_PIN_2
#define motor_2_position_A_GPIO_Port GPIOB
#define motor_2_position_A_EXTI_IRQn EXTI2_3_IRQn
#define motor_1_position_B_Pin GPIO_PIN_12
#define motor_1_position_B_GPIO_Port GPIOB
#define motor_1_position_A_Pin GPIO_PIN_13
#define motor_1_position_A_GPIO_Port GPIOB
#define motor_1_position_A_EXTI_IRQn EXTI4_15_IRQn
#define jack_2_position_B_Pin GPIO_PIN_14
#define jack_2_position_B_GPIO_Port GPIOB
#define jack_2_position_A_Pin GPIO_PIN_15
#define jack_2_position_A_GPIO_Port GPIOB
#define jack_2_position_A_EXTI_IRQn EXTI4_15_IRQn
#define jack_1_position_B_Pin GPIO_PIN_8
#define jack_1_position_B_GPIO_Port GPIOA
#define jack_1_position_A_Pin GPIO_PIN_9
#define jack_1_position_A_GPIO_Port GPIOA
#define jack_1_position_A_EXTI_IRQn EXTI4_15_IRQn
...
#define jack_2_move_open_Pin GPIO_PIN_0
#define jack_2_move_open_GPIO_Port GPIOD
#define jack_2_move_close_Pin GPIO_PIN_1
#define jack_2_move_close_GPIO_Port GPIOD
#define jack_1_move_open_Pin GPIO_PIN_4
#define jack_1_move_open_GPIO_Port GPIOD
#define jack_1_move_close_Pin GPIO_PIN_5
#define jack_1_move_close_GPIO_Port GPIOD
#define receiver_1_down_first_order_Pin GPIO_PIN_6
#define receiver_1_down_first_order_GPIO_Port GPIOD
#define receiver_1_up_second_order_Pin GPIO_PIN_3
...
#define receiver_2_down_first_order_Pin GPIO_PIN_6
#define receiver_2_down_first_order_GPIO_Port GPIOB
#define receiver_2_up_second_order_Pin GPIO_PIN_7
#define receiver_2_up_second_order_GPIO_Port GPIOB
...
#define interface_encoder_A_Pin GPIO_PIN_10
